...
export class NetworkingEventosComponent {
  ...
  searchText: string = '';
  eventos = [
    { nombre: 'Conferencia:Contrato de Inversión, Acuerdos Comerciales y Tratados de Libre Comercio - Capítulo Ecuador 2025', lugar: 'Instituto Tsáchila, Santo Domingo', fecha: 'Jueves 3 de abril del 2025', imagen: 'assets/bannertec.png' },
    ...
    { nombre: 'Tsáchila Business Convention #TBC2025', lugar: 'Hotel Zaracay', fecha: 'Jueves 23 de octubre 2025', imagen: 'assets/congresos.jpg' }
  ];
